...
function Register(props) {
  ...
  const isModal = typeof props.setRegister === 'function'
    ...
    <>
      <div className={isModal ? 'fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-fadeIn' : 'min-h-screen w-full flex flex-col justify-center items-center relative overflow-hidden bg-slate-50 pt-24 pb-12 px-4'}>
        ...
        <form 
          ...
          className="relative z-10 flex flex-col gap-4 w-full max-w-[400px] bg-white border border-slate-100 shadow-2xl p-8 sm:p-10 text-slate-600 rounded-2xl animate-fadeInUp"
        ...
        >
          ...
          <div className="text-center mb-2 overflow-hidden">
            ...
            <p className="text-slate-500 text-sm mt-1">
              Join us to book your dream stays
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="w-full">
              ...
              <input 
                ...
                placeholder="John" 
                className="bg-slate-50 border border-slate-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 rounded-xl w-full p-2.5 text-slate-900 placeholder-slate-400 outline-none transition-all duration-300" 
                type="text" 
                required 
              />
            </div>
          ...
          <div className="w-full">
            ...
            <div className='relative w-full'>
              <input 
                ...
                value={form.password} 
                placeholder="••••••••" 
                className="bg-slate-50 border border-slate-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 rounded-xl w-full p-2.5 pr-11 text-slate-900 placeholder-slate-400 outline-none transition-all duration-300" 
          ...
          {errorMsg && (
            <div className="bg-red-50 border border-red-200 rounded-xl p-2.5 text-red-600 text-xs flex items-center gap-2 animate-fadeIn">
