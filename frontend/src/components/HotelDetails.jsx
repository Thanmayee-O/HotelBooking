...
function HotelDetails(props) {
    ...
    const [checkIn , setCheckIn] = useState(location.state?.bookingData?.checkIn || '')
    const [checkOut , setCheckOut] = useState(location.state?.bookingData?.checkOut || '')
    const [guests , setGuests] = useState(location.state?.bookingData?.guests || '')    
           ...
           if (!token) {
             navigate('/login', { 
               state: { 
                 ...
                 bookingData: { checkIn, checkOut, guests } 
               } 
             });
             return;
           }
