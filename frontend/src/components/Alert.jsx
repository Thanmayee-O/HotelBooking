    ...
    return (
        <div className="flex items-center justify-between text-blue-600 max-w-80 w-full shadow bg-white h-10">
            ...
            <div className="flex items-center">
                ...
                <p className="text-sm ml-2">{message || "Success! Your task is fully completed."}</p>
            </div>   
            <button type="button" aria-label="close" className="active:scale-90 transition-all mr-3" onClick={onClose}>
